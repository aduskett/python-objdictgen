...
def get_class_from_store(classname):
    ...
    return CLASS_STORE.get(classname, None) or pickle.get(classname, None)
...
def subnodes(node):
    ...
    return [n for n in node.childNodes if hasattr(n, '_attrs') and n.nodeName != '#text']
