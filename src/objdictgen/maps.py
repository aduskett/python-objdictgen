...
class ODStructTypes:
    ...
    NRECORD = (
        Subindex | MultipleSubindexes | IdenticalIndexes
    )  # 11, Example : PDO Parameters
    NARRAY = (
        Subindex | MultipleSubindexes | IdenticalSubindexes | IdenticalIndexes
    )  # 15, Example : PDO Mapping
...
INDEX_RANGES = [
    ...
    {"min": 0x1200, "max": 0x12FF, "name": "sdop", "description": "SDO Parameters"},
    {
        ...
        "max": 0x15FF,
        "name": "rpdop",
        "description": "Receive PDO Parameters",
    },
    {
        "min": 0x1600,
        "max": 0x17FF,
    ...
    },
    {
        ...
        "max": 0x19FF,
        "name": "tpdop",
        "description": "Transmit PDO Parameters",
    },
    {
        "min": 0x1A00,
        "max": 0x1BFF,
    ...
    },
    {
        ...
        "max": 0x1FFF,
        "name": "ocp",
        "description": "Other Communication Parameters",
    },
    {
        "min": 0x2000,
        "max": 0x5FFF,
    ...
    },
    {
        ...
        "max": 0x9FFF,
        "name": "sdp",
        "description": "Standardized Device Profile",
    },
    {
        "min": 0xA000,
        "max": 0xBFFF,
        "name": "sip",
        "description": "Standardized Interface Profile",
    },
]
...
# Change the information within it if there is a mistake. But don't modify the
...
MAPPING_DICTIONARY = {
    ...
    0x1000: {
        ...
        "struct": OD.VAR,
        "need": True,
        "values": [{"name": "Device Type", "type": 0x07, "access": "ro", "pdo": False}],
    },
    0x1001: {
        "name": "Error Register",
        "struct": OD.VAR,
    ...
    0x1005: {
        ...
        "need": False,
        "callback": True,
        "values": [{"name": "SYNC COB ID", "type": 0x07, "access": "rw", "pdo": False}],
    },
    0x1006: {
    ...
    0x100C: {
        ...
        "struct": OD.VAR,
        "need": False,
        "values": [{"name": "Guard Time", "type": 0x06, "access": "rw", "pdo": False}],
    },
    0x100D: {
    ...
    0x1012: {
        ...
        "struct": OD.VAR,
        "need": False,
        "values": [{"name": "TIME COB ID", "type": 0x07, "access": "rw", "pdo": False}],
    },
    0x1013: {
    ...
    0x1201: {
        "name": "Additional Server SDO %d Parameter[(idx)]",
        "struct": OD.NRECORD,
        "incr": 1,
        "nbmax": 0x7F,
        "need": False,
